<template>
    <div class="round-input">
        ...
        <div v-if="! players.length && ! temp_players.length && ! loading" class="alert alert-info text-center">
            <p><strong>Let's get started</strong> by adding some players to your team.</p>
        </div>
        ...
        <div v-if="! selected_players.length && (players.length || temp_players.length) && ! loading" class="alert alert-info text-center">
            <p><strong>Select some players</strong> so you can fill in their quarters and select best players.</p>
        </div>

        <div v-if="errors.submission_error && ! errors.quarter_input.invalid" class="alert alert-danger text-center" role="alert">
