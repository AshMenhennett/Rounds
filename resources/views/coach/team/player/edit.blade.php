...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <a href="{{ route('coach.team.players.index', $team) }}">&laquo; Players</a>
            <br />
            <div class="panel panel-default">
                <div class="panel-heading">Edit player for {{ strtoupper($team->name) }}</div>

                <div class="panel-body">
                    <form action="{{ route('coach.team.player.update', [$team, $player]) }}" method="post">
                        ...
                        <a href="{{ route('coach.team.players.index', $team) }}" class="btn btn-default pull-right btn-ok-cancel-relation">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
